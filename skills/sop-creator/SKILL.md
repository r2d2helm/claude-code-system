...
### Infrastructure (r2d2 system)
| Type | When to Use |
|------|-------------|
| **Runbook** | Incidents Proxmox/Windows/Docker/Linux, on-call |
| **Deployment Playbook** | Releases, migrations, mises à jour infra |
| **Troubleshooting Guide** | Debugging VMs, conteneurs, réseau |
| **How-To Guide** | Configuration initiale, setup |
| **Checklist** | Vérification pré/post-maintenance |
...
When creating SOPs for the r2d2 system, store them in the Obsidian vault:

- **Path:** `Knowledge/References/SOPs/`
